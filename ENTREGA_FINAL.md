...
Aluno "1" --> "*" Matricula
Curso "1" --> "*" Matricula
Matricula "1" --> "*" Solicitacao
Matricula "1" --> "0..1" Certificado
Matricula "1" --> "*" IncidenteIntegridade
Avaliacao "1" --> "*" AvaliacaoRealizada
Aluno "1" --> "*" AvaliacaoRealizada
```
